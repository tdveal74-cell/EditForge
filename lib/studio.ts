...
export const STUDIO_MODULES: StudioModule[] = [
  ...
  { id: "audio", dept: "Sound", label: "Audio hierarchy", href: "/audio", status: "planner", studioRole: "Edit stored ladder rules, emit law — not Fairlight" },
  { id: "mix", dept: "Sound", label: "Mix bridge", href: "/mix", status: "bridge", studioRole: "Desk of the stored ladder + session dump — not Fairlight" },
  ...
  { id: "longform", dept: "Deliverables", label: "Long-form render", href: "/longform", status: "planner", studioRole: "Stored chapters → stitch plan — not a running episode renderer" },
  ...
  { id: "captions", dept: "Finishing", label: "Captions", href: "/captions", status: "planner", studioRole: "Cues overlay the reference clip, persist, emit SRT/VTT — not a live captioner" },
  { id: "titles", dept: "Finishing", label: "Titles", href: "/titles", status: "planner", studioRole: "Type in motion on the frame, persist, emit JSON — not After Effects" },

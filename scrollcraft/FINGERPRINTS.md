...
- Split stage, create vs finish, divider as chrome
- Close is a collapse into the finish room with the label Open Canvas
- Signature: a still dropping from a graph node onto a timeline
- 5-act score at about 8.8vh (outside the 6 to 7 act / 13.6vh band)
- House of rooms, department strip, stamp-into-strip as the house signature
- Rubric close as an inverting gate bar
- Dailies as a pan gallery whose labels are facts
